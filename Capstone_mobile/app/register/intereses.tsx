    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.header}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.title}>¿Qué temas te interesan?</Text>
            <Text style={styles.subtitle}>Puedes marcar más de una opción.</Text>
          </View>
        </View>
